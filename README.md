<div align="center">
  ...
  <strong>The Next-Generation AI-Powered Development Platform with an Integrated Community Hub</strong></p>
  <p>
    <a href="#-installation"><strong>Installation</strong></a> •
    <a href="#-core-features"><strong>Features</strong></a> •
    <a href="#-supported-ai-providers"><strong>AI Providers</strong></a> •
    <a href="#-titan-nexus-community-hub"><strong>Community</strong></a> •
...
🔗 Live Platform: titan1.pages.dev
✨ Core Features
...
bash# Install pnpm if you don't have it
npm install -g pnpm
...
Open the Titan AI dashboard
Select your preferred model provider from the dropdown
Click the ✏️ icon to edit settings
Securely input your API credentials

🌐 Configuring Custom Base URLs
For providers that support custom endpoints (like Ollama or LM Studio):

Access ⚙️ > Providers from the main menu
Locate your provider
Enter your custom endpoint URL (e.g., http://localhost:11434)
...
bash# Standard workflow: Fork → Branch → Commit → PR
